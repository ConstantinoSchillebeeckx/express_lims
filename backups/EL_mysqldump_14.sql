...
CREATE TABLE `matatu_test` (
  ...
  `asdf` varchar(191) DEFAULT NULL,
  `asdfa` int(32) DEFAULT NULL,
  PRIMARY KEY (`_UID`),
  UNIQUE KEY `asdf` (`asdf`),
  UNIQUE KEY `asdfa` (`asdfa`)
...
INSERT INTO `matatu_test` VALUES (5,'234',23434);
...
-- Dump completed on 2016-09-14  9:37:23
